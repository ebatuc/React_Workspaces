                                                ...
                                                <table className="table">
                                                    <tbody>
                                                        ...
                                                        <tr className="shipping">
                                                            <th>Shipping</th>
                                                            <td>
                                                                <span className="price-ammount">$ {(this.props.cart.reduce((total, cartItem) => total + (cartItem.quantity * cartItem.product.price), 0).toFixed(1)) * 0.15}</span>
                                                            </td>
                                                        </tr>
                                                        <tr className="cart-total">
                                                            <th>TOTAL</th>
                                                            <td>
                                                                <span className="price-ammount">$ {(this.props.cart.reduce((total, cartItem) => total + (cartItem.quantity * cartItem.product.price), 0).toFixed(1)) * 1.15}</span>
                                                            </td>
                                                        </tr>
                                                    </tbody>
                                                </table>
