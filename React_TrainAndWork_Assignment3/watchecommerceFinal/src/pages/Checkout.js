...
class Checkout extends Component {
    ...
    handleFormSubmit = async (e) => {
        ...
        const personalInfo = {
            ...
            townCity: this.state.billing_townCity,
        ...
        const orderedProductsId = uuidv4();
        ...
        const order = {
            ...
            orderedProducts: orderedProductsId,
        };

        try {
            await axios.post('http://localhost:3000/orderedProducts', orderedProducts)
            await axios.post('http://localhost:3000/personalInfo', personalInfo);
                                                        ...
                                                        <table className="table">
                                                            ...
                                                            <tfoot>
                                                                <tr className="cart-subtotal">
                                                                    <th>Cart Subtotal</th>
                                                                    <td>$ {this.props.cart.reduce((total, cartItem) => total + (cartItem.quantity * cartItem.product.price), 0).toFixed(1)}</td>
                                                                </tr>
                                                                <tr className="shipping">
                                                                    <th>Shipping</th>
                                                                    <td>$ {(this.props.cart.reduce((total, cartItem) => total + (cartItem.quantity * cartItem.product.price), 0).toFixed(1)) * 0.15}</td>
                                                                </tr>
                                                                <tr className="order-total">
                                                                    <th>Order Total</th>
                                                                    <td>
                                                                        <span className="order-total-ammount">$ {(this.props.cart.reduce((total, cartItem) => total + (cartItem.quantity * cartItem.product.price), 0).toFixed(1)) * 1.15}</span>
                                                                    </td>
                                                                </tr>
                                                            </tfoot>
                                                        </table>
